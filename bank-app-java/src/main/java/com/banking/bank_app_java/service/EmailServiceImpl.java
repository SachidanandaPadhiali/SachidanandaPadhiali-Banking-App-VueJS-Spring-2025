    ...
    public void sendSignUpEmail(EmailDetails emailDetails) {
        try {
            ...
            String htmlContent = "<div style=\"font-family: Arial, sans-serif; background-color: #f4f4f4; padding: 40px;\">"
                    ...
                    + "<h2 style=\"color: #134B70;\">Welcome to MyBank</h2>"
                    + "</div>"
                    + "<p style=\"font-size: 16px; color: #333;\">Dear <strong>" + emailDetails.getSavedUser().getFirstName() + "</strong>,</p>"
                    ...
                    + "Account Holder: " + emailDetails.getSavedUser().getFirstName() + "<br>"
                    + "Account Number: " + emailDetails.getSavedUser().getAccNo() + "<br>"
                    + "Account Type: Savings Account<br>"
                    + "Status: Active<br>"
                    + "Address: "+ emailDetails.getSavedUser().getAddressLine1() + ", " + emailDetails.getSavedUser().getAddressLine2()
                    + ", " + emailDetails.getSavedUser().getCity() + ", " + emailDetails.getSavedUser().getState() + ", " + emailDetails.getSavedUser().getPin()
                    + "e<br>Linked Phone Number: " + emailDetails.getSavedUser().getPhoneNumber()
                    + "</div>"
